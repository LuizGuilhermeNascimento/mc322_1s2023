...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Veiculo veiculo1 = new Veiculo("ABC1D23","Marca1","Modelo1");
        Veiculo veiculo2 = new Veiculo("EFG1H23","Marca2","Modelo2");
        ...
        // OBS: Os métodos toString() das demais já foram utilizados na listagens dos clientes e sinistros



        System.out.println("\n\n------------ PESQUISE CLIENTE CADASTRADO A PARTIR DO DOCUMENTO ------------");
